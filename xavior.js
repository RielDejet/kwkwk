...
let template = await generateWAMessageFromContent(m.chat, proto.Message.fromObject({
          ...
          listType: 1
            ...
            case 'okay': { m.reply('FOLLW IG OWNER RERE:')} break
            
             case 'menu': {
            anu = `Hallo Kak... 🤗\nSalken Bre, Gua *Rere*😍\nGua Bot WhatsApp MD Kak..\nBot WA MD By Rielgans🐤\nInfo Lanjut Dengerin VN nya Kak`
            let btn = [{
